    ...
    return (
        <div className="content about-us ">
            <div className="about-content">
                ...
                <p>We prefer to rely on instinct and feel, measuring by hand, not by the gram. This is the authentic way to make pizza. Sure it’s a little unrefined, but we’re proud of that. 
            ...
            <div className="features">
                <div className="careful feature">
                    ...
                    <h1>We're Careful</h1>
                    <p>The crust is stored in a separate container, on a separate shelf in our fridge. The cheese, marinara sauce and pepperoni are stored in a  designated kit, 
